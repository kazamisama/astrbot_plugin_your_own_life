...
### 兼容矩阵（2026-08-12 快照，本插件行已更新至 v0.5.19）
...
| astrbot_plugin_your_own_life（本插件） | v0.5.19 | 无独立 `_PUBLIC_API.md`；跨插件调用全部经适配层 | kazamisama/astrbot_plugin_your_own_life | 本插件（L1/L1.5 已交付，L2-01 至 L2-11 全部已落地，v0.5.0-v0.5.19） |
